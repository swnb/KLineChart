                    ...
                    if (!consumed && this._startScrollCoordinate !== null) {
                        ...
                        if (this._prevYAxisRange !== null && !yAxis.getAutoCalcTickFlag() && yAxis.getScrollZoomEnabled()) {
                            ...
                            if ((_c = yAxis === null || yAxis === void 0 ? void 0 : yAxis.isReverse()) !== null && _c !== void 0 ? _c : false) {
                                distance = this._startScrollCoordinate.y - event_3.y;
                            }
                            else {
                                distance = event_3.y - this._startScrollCoordinate.y;
                            }
                            var scale = distance / bounding.height;
                        ...
                        var pressedDominantHorizontalDrag = Math.abs(distanceX) >= 4 && Math.abs(distanceX) > Math.abs(distanceY) * 1.2;
...
var ChartImp = /** @class */ (function () {
    ...
    ChartImp.prototype.setPriceAxisAutoScale = function (autoScale, paneId) {
        var pane = isString(paneId) ? this.getDrawPaneById(paneId) : this._candlePane;
        if (pane !== null) {
